    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_picture', models.ImageField(default='blank_profile_pic.png', upload_to='profile_image')),
                ('specialty', models.CharField(blank=True, choices=[('general doctor', 'General Doctor'), ('epidemiologist', 'Epidemiologist'), ('general practitioner', 'General practitioner'), ('pediatrician', 'Pediatrician'), ('dentist', 'Dentist'), ('surgeon', 'Surgeon'), ('dermatologist', 'Dermatologist'), ('plastic surgeon', ' Plastic Surgeon'), ('psychiatrist', 'Psychiatrist')], max_length=20)),
                ('professional_license', models.CharField(max_length=25, unique=True)),
                ('hospital', models.CharField(blank=True, choices=[('Harvey Hospital(Yaba, Lagos)', 'Harvey State Hospital Yaba'), ('U.C.H(Gate, Ibadan)', 'University College Hospital Ibadan'), ('LUTH(Onipanu, Lagos)', 'Lagos State University Teaching Hospital'), ('Oluyoro(Oluyoro Agugu, Ibadan)', 'Oluyoro Catholic Hospital'), ('UITH(Eleko Road Ilorin)', 'University of Ilorin College Hospital')], max_length=50)),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
